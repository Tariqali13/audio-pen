...
const ProcessingBox = (props) => {
  ...
  return (
    <div className="w-full relative flex flex-col justify-center items-center px-[135px] pt-[58.63px] pb-[32.39px]">
      <div class="chase-spinner">
        <div class="dot1"></div>
        <div class="dot2"></div>
      </div>
      <div className="font-dmsans text-stone-100 mt-[29px] mb-2 text-[22px] w-full font-normal leading-[33px]">
